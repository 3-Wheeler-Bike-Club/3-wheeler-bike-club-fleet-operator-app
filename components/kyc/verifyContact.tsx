...
import { getOperatorByPhoneAction } from "@/app/actions/kyc/getOperatorByPhoneAction"
                              ...
                              render={({ field }) => (
                                  <FormItem>
                                      ...
                                      <FormLabel>Enter your email address</FormLabel>
                                          <FormControl >
                                              <Input autoComplete="off" disabled={ !!operator?.email || !!email || loadingCode || isDisabledEmail } className="col-span-3" placeholder={""} {...field} />
                                          </FormControl>
                                      </div>
                                  </FormItem>
                              )}

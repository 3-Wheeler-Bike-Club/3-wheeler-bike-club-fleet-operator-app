...
import { updateGuarantorAction } from "@/app/actions/onboard/updateGuarantorAction"
...
interface VerifyGuarantorKYCProps {
  address: `0x${string}`
  guarantor: Guarantor
  getGuarantorSync: () => void
}

export function VerifyGuarantorKYC({ address, guarantor, getGuarantorSync }: VerifyGuarantorKYCProps) {
      ...
      if(nationalFiles && nationalFiles.length > 0 && licenseFiles && licenseFiles.length > 0 && headshotFiles && headshotFiles.length > 0) {
        ...
        const uploadHeadshotFiles = await startUpload(headshotFiles);
          if(uploadNationalFiles && uploadLicenseFiles && uploadHeadshotFiles) {
            ...
            const updateGuarantor = await updateGuarantorAction(
              address!,
                  ...
                  <Form {...manualForm}>
                    <form onSubmit={manualForm.handleSubmit(onSubmitManual)} className="space-y-6">
                                ...
                                <FormItem>
                                    <div className="flex flex-col gap-1 w-full max-w-sm space-x-2">
                                        ...
                                        <FormControl >
                                            <Input 
                                            autoComplete="off" 
                                            disabled={ !!guarantor.firstname || loading } 
                                            className="col-span-3" 
                                            placeholder={guarantor.firstname ? guarantor.firstname.toUpperCase() : "VITALIK"} 
                                            {...field}
                                            onChange={(e) => {
                                ...
                                <FormItem>
                                    <div className="flex flex-col gap-1 w-full max-w-sm space-x-2">
                                        ...
                                        <FormControl >
                                            <Input 
                                                autoComplete="off" 
                                                disabled={ !!guarantor.othername || loading } 
                                                className="col-span-3" 
                                                placeholder={guarantor.othername ? guarantor.othername.toUpperCase() : "DOTETH"} 
                                                {...field}
                                                onChange={(e) => {
                                                    field.onChange(e.target.value.toUpperCase())
                                                }}
                                ...
                                <FormItem>
                                    <div className="flex flex-col gap-1 w-full max-w-sm space-x-2">
                                        ...
                                        <FormControl >
                                            <Input 
                                                autoComplete="off" 
                                                disabled={ !!guarantor.lastname || loading } 
                                                className="col-span-3" 
                                                placeholder={guarantor.lastname ? guarantor.lastname.toUpperCase() : "BUTERIN"} 
                                                {...field}
                                                onChange={(e) => {
                                                    field.onChange(e.target.value.toUpperCase())
                                                }}
                                    ...
                                    <div className='flex flex-col gap-1 w-full max-w-sm space-x-2'>
                                        <FormLabel className="text-yellow-600">Country</FormLabel>
                                        {
                                            ...
                                            :(
                                                <>
                                                <FormControl>
                                                    <Input disabled className='col-span-3' placeholder={guarantor.country} {...field} />
                                                </FormControl>
                                                </>
                                            )
                                        }
                                        ...
                                        <FormControl >
                                                <div className="flex items-center gap-2">
                                                    <Input 
                                                        ...
                                                        placeholder={guarantor.location ? guarantor.location.toUpperCase() : "https://goo.gl/maps/..."} 
                                                        {...field}
                                                        onChange={(e) => {
                                                            field.onChange(e.target.value.toUpperCase())
                                                        }}
                      ...
                      <div className="flex">
                          ...
                          <Button
                              className="w-full"
                              disabled={loading || guarantor.national.length > 0}
                              type="submit"
                          >
                              {
                                  loading
